...
export const CLIENT_ACTION_ON_CLIENT_APP_HEADER_BUTTON_CLICK = "OnClientAppHeaderButtonClick";
// **********************************************************************************************
...
export type ButtonType = 'Notification' | 'systemSettings' | 'SystemAvatar' | 'Support' | 'Announcekit' | 'Regular';
